     <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						...
						<li>
                            <a href="subjects.php"><i class="icon-chevron-right"></i><i class="icon-list-alt"></i> lesson</a>
                        </li>
						<li>
						...
						<li>
                            <a href="school_year.php"><i class="icon-chevron-right"></i><i class="icon-calendar"></i> Batch</a>
                        </li>
						<li class="">
