        ...
        <div class="span9" id="content">
            <div class="row-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">Batch: <?php echo $school_year_query_row['school_year']; ?></a></li>
                </ul>
                <!-- end breadcrumb -->
                    ...
                    <div class="block-content collapse in">
                        <div class="span12">
                            <form action="read.php" method="post">
                                ...
                                $not_read_query = mysqli_query($conn, "
                                        SELECT COUNT(*) AS unread_count
                                        FROM notification
                                        LEFT JOIN notification_read ON notification.notification_id = notification_read.notification_id
                                        WHERE notification_read.student_id = '$session_id' AND notification_read.student_read IS NULL
                                    ") or die(mysqli_error($conn));
                                $not_read_result = mysqli_fetch_array($not_read_query);
                                $not_read = $not_read_result['unread_count'];
                                ...
                                if ($count > 0) {
                                    while ($row = mysqli_fetch_array($query)) {
                                        ...
                                        $query_yes_read = mysqli_query($conn, "
                                                ...
                                                WHERE notification_id = '$id' AND student_id = '$session_id'
                                            ") or die(mysqli_error($conn));
